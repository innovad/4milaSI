...
public class SICardV8FamilyProcessorTest {
  ...
  @Test
  public void testV8() throws DownloadException, IOException {
    ...
    Assert.assertEquals("36", processor.getControlData().get(0).getControlNo());
    Assert.assertEquals("31", processor.getControlData().get(1).getControlNo());
    Assert.assertEquals("32", processor.getControlData().get(2).getControlNo());
    Assert.assertEquals("38", processor.getControlData().get(3).getControlNo());
    Assert.assertEquals("35", processor.getControlData().get(4).getControlNo());
    Assert.assertEquals("34", processor.getControlData().get(5).getControlNo());
    Assert.assertEquals("33", processor.getControlData().get(6).getControlNo());
    Assert.assertEquals("37", processor.getControlData().get(7).getControlNo());
    Assert.assertEquals("58", processor.getControlData().get(8).getControlNo());
    Assert.assertEquals("54", processor.getControlData().get(9).getControlNo());

    Assert.assertEquals("56", processor.getControlData().get(10).getControlNo());
    Assert.assertEquals("49", processor.getControlData().get(11).getControlNo());
    Assert.assertEquals("40", processor.getControlData().get(12).getControlNo());
    Assert.assertEquals("41", processor.getControlData().get(13).getControlNo());
    Assert.assertEquals("39", processor.getControlData().get(14).getControlNo());
    Assert.assertEquals("51", processor.getControlData().get(15).getControlNo());
    Assert.assertEquals("59", processor.getControlData().get(16).getControlNo());
    Assert.assertEquals("47", processor.getControlData().get(17).getControlNo());
    Assert.assertEquals("48", processor.getControlData().get(18).getControlNo());
    Assert.assertEquals("46", processor.getControlData().get(19).getControlNo());

    Assert.assertEquals("44", processor.getControlData().get(20).getControlNo());
    Assert.assertEquals("43", processor.getControlData().get(21).getControlNo());
    Assert.assertEquals("53", processor.getControlData().get(22).getControlNo());
    Assert.assertEquals("45", processor.getControlData().get(23).getControlNo());
    Assert.assertEquals("42", processor.getControlData().get(24).getControlNo());
    Assert.assertEquals("50", processor.getControlData().get(25).getControlNo());
  ...
  public void testV10() throws Exception {
    ...
    Assert.assertEquals("37", processor.getControlData().get(0).getControlNo());
    Assert.assertEquals("38", processor.getControlData().get(1).getControlNo());
    Assert.assertEquals("39", processor.getControlData().get(2).getControlNo());
    Assert.assertEquals("40", processor.getControlData().get(3).getControlNo());
    Assert.assertEquals("41", processor.getControlData().get(4).getControlNo());
    Assert.assertEquals("42", processor.getControlData().get(5).getControlNo());
    Assert.assertEquals("43", processor.getControlData().get(6).getControlNo());
    Assert.assertEquals("43", processor.getControlData().get(7).getControlNo());
